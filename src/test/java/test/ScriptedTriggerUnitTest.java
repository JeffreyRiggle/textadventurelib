...
public class ScriptedTriggerUnitTest {
	...
	public void setup() {
		try {
			File simple = new File("src/test/java/test/SimpleTrigger.js");
			simpleTriggerScript = FileUtilities.getFileContent(simple);
			File bad = new File("src/test/java/test/badTrigger.js");
			complexTriggerScript = FileUtilities.getFileContent(bad);
			File complex = new File("src/test/java/test/ComplexTrigger.js");
