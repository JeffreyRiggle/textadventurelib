...
public class AppendTextAction implements IAction{
	...
	public AppendTextAction(String text) {
		LogRunner.logger().log(Level.FINE, String.format("Creating Append Text Action with text: %s", text));
		appendText = text;
	...
	public void addListener(IMessageListener listener) {
		LogRunner.logger().log(Level.FINEST, "Adding Listener to append text action");
	...
	public void removeListener(IMessageListener listener) {
		LogRunner.logger().log(Level.FINEST, "Removing Listener from append text action");
		listeners.remove(listener);
	}
	
	@Override
	public void execute(ExecutionParameters params) {
		LogRunner.logger().log(Level.FINEST, String.format("Executing Append Text Action with text: %s", appendText));
